...
<input readonly autofocus style="width:0px; height:0px; border:none;"> <!-- bu çok saçma bir focus yöntemi ancak şimdilik iş görüyor. -->
	<div class="giris">
		<div class="giris-div">
			...
			<h5 id="giris-yazilar-1">
				Şifre :<br/>
				Minimum 8 karakterden oluşmalı<br/>
				1 adet büyük harf<br/>
				1 adet küçük harf<br/>
				1 adet rakam içermeli<br/>
				Türkçe karakter içermemelidir.
			</h5>
			<div id="sozlesme" ><input type="checkbox" name=""><a href="#">sözleşmeyi okudum ve kabul ediyorum.</a></div>
			<br/>
			<div class="hatadiv">
				...
				@$kullanicibilgisi = $kayitkullaniciadi;
				...
				if (isset($_POST['kullaniciadikayit']) && isset($_POST['sifrekayit']) && isset($_POST['mail'])) 
				{
					...
					{
						if (!preg_match('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)+[0-9a-zA-Z][a-zA-Z0-9]{7,}$/', $kayitsifre) || !filter_var($kayitmailbilgisi, FILTER_VALIDATE_EMAIL))
						{
							?><script type="text/javascript">document.getElementById("hatamesaj").style.display="block";</script><?php
						}
						else
						{
							...
							$komut->execute();
							?><script type="text/javascript">document.getElementById("dogrulamamesaji").style.display="block";</script><?php
