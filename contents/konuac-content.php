<?php 
	...
	else
	{
		...
		<form method="POST" action="">
			...
			<textarea style="width:70%; height: 100px; display: block; position: relative; top:40px; resize: none; margin: auto;" name="konu_icerikk" placeholder="konu içeriği (maksimum 3000 karakter)" maxlength="3000" required></textarea>
